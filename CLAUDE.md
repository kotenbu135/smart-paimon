...
- `build_team_member(json, character_id, weapon_activations, artifact_activations, talent_activations, traveler_element?)` → TeamMember (v0.5.6): キャラ天賦バフ + 武器バフ + 聖遺物バフ + conditional activations を全て含む
